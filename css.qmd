...
```{r echo=FALSE}
knitr::include_url("http://www.csszengarden.com/")
```

### HTML

```{html file='A348/CSS/CSS_zen/color_block/index.html'}
#| code-fold: true
#| code-summary: "Show the HTML"
```

### MID CENTURY MODERN 

```{r echo=FALSE}
knitr::include_url("http://www.csszengarden.com/221")
```

### STEEL 

```{r echo=FALSE}
knitr::include_url("http://www.csszengarden.com/219")
```

### ROBOT 

```{r echo=FALSE}
knitr::include_url("http://www.csszengarden.com/215")
```


### CSS-MIDCENTURY

```{html file='A348/CSS/CSS_zen/color_block/style.css'}
#| code-fold: true
#| code-summary: "Show the CSS of Mid-century Modern"
```
