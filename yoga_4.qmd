...
Use Resort-4 as a template, **Pacific Trails Resort Chapter 5 folder**.
...
Edit classes.html to match the new wireframe. Refer to the book instrcutions.

### Task 5 Schedule Page

Edit schedule.html. Refer to the book instrcutions.
